...
#Z_test_use = Z_test_use_nolim[Z_test_use_nolim>cuts[1] and Z_test_use_nolim<cuts[2]]
#Z_test_predicted = Z_test_predicted_nolim[Z_test_predicted_nolim>cuts[1] and Z_test_predicted_nolim<cuts[2]]
#Z_reco_test = Z_reco_test_nolim[Z_reco_test_nolim>cuts[1] and Z_reco_test_nolim<cuts[2]]
...
#print(type(R_test_use_predicted),type(R_test_predicted), type(weights_Rpredicted))
