...
parser.add_argument("-o", "--outdir",type=str,default='/mnt/home/willis51/LowEnergyNeuralNetwork/output_plots/FullSample',
...
dist_title='NuMu and NuE'

plot_distributions(R_test_usereco,log=False,
                                    save=save, savefolder=save_folder_name,
                                    weights=weights_Rreco,reco_name = 'Retro',
                                    variable='R', units= '(m)',
                                    bins=bins,
                                    title="Testing R Distribution for %s"%dist_title)
