...
plot_2D_prediction(Y_test_use[:,true_index],\
                 ...
                 variable=plot_name,units=plot_units, minval=minrange, maxval=maxrange, axis_square=True)
...
plot_bin_slices(Y_test_use[:,true_index], Y_test_predicted[:,NN_index]*maxabs_factor,\
                  use_fraction = False,\
                  bins=20,min_val=minrangefrac,max_val=maxrangefrac,\
