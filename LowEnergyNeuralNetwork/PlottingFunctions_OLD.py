...
def plot_history_from_list_split(energy_loss,val_energy_loss,zenith_loss,val_zenith_loss,z_loss,val_z_loss,save=True,savefolder=None,logscale=False,ymin=None,ymax=None,title=None):
    
    plt.figure(figsize=(10,7))
    plt.plot(energy_loss,'b',label="X Training")
    plt.plot(val_energy_loss,'c',label="X Validation")
    plt.plot(zenith_loss,'r',label="Y Training")
    plt.plot(val_zenith_loss,'m',label="Y Validation")
    plt.plot(z_loss,'g',label="Z Training")
    plt.plot(val_z_loss,'lime',label="Z Validation")
...
def plot_bin_slices(truth, nn_reco, energy_truth=None, weights=None,\
    ...
    print(variable, variable == "R Position")
