...
for epoch in range(start_epoch,end_epoch):
    ...
    f.close() 
    del f
    Y_train[:,4] = Y_train[:,4]/200.
    Y_train[:,5] = Y_train[:,5]/200.
    Y_train[:,6] = Y_train[:,6]/200.
    Y_validate[:,4] = Y_validate[:,4]/200.
    Y_validate[:,5] = Y_validate[:,5]/200.  
    Y_validate[:,6] = Y_validate[:,6]/200. 
